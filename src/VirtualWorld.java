    ...
    */
    ...
    public void mousePressed() {
        ...
        if (entityOptional.isPresent()) {
            ...
            System.out.println(entity.getId() + ": " + entity.getClass()+ " : "); // removed entity.gethealth as not all entitys have it
        }
    ...
    public void scheduleActions(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        for (Entity entity : world.getEntities()) {
            if (entity instanceof AnimationEntity) {
                ((AnimationEntity) entity).scheduleActions(world, imageStore, scheduler);
